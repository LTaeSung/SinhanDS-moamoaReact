...
//   };
//   // 전체 멤버 목록 가져오기
//   const fetchAllMemberList = async () => {
//     try {
//       const response = await axios.get(`${bootpath}/member/all`);
//       setAllMemberList(response.data);
//     } catch (error) {
//       console.error("전체 멤버 목록을 불러오는 중 오류 발생:", error);
//     }
//   };
...
//       return false;
//     }
//     return friendList.some((friend) => friend.friendId === userId);
//   };
//   const getMember = () => {
//     axios
